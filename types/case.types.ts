...
export const GEMINI_RESPONSE_SCHEMA = {
  ...
  properties: {
    ...
    summary: { type: "string" as const, description: "Plain-language summary of the document's purpose and key obligations" },
    extractedTerms: {
      type: "array" as const,
      items: {
        type: "object" as const,
    ...
    risks: {
      ...
      items: {
        ...
        properties: {
          ...
          sourceText: { type: "string" as const, description: "Exact verbatim text from the document that triggers this risk flag" },
          explanation: { type: "string" as const, description: "Explanation of why this is flagged and what it means" },
    ...
    recommendations: {
      ...
      description: "List of recommended actions or considerations for the user",
    },
